...
**Title:** Portable-VDM Datasheet
**Slug:** `portable-vdm-datasheet`
**Category:** Lynx-Sold Scoreboards and Displays › Datasheets
**Type:** datasheet
**Source URL:** https://finishlynx.com/wp-content/uploads/2024/03/Portable-VDM_Datasheet.pdf
...
Convenient solution to connect a Lynx Video Display (Portable, Infield, 360) for those who don’t have a Vision camera
and cannot use the VDM upgrade, or for those who want more flexibility to decide on the location of their LED video
displays for track or for field events.
...
*ResulTV-VDM is a simplified version of ResulTV. Like the VDM option for Vision-series cameras, the content of the
